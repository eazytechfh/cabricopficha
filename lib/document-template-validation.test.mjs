...
test("accepts only known document template kinds", () => {
  ...
  assert.equal(parseDocumentTemplateKind("other-services-contract"), "other-services-contract")
  assert.equal(parseDocumentTemplateKind("other-services-procuration"), "other-services-procuration")
