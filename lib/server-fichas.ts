...
function toPayload(data: FichaFormValues, consultor: ConsultorSession, mode: "create" | "update") {
  ...
  return {
    ...
    telefone_terceiros: normalizedData.telefoneTerceiros || null,
    email_terceiros: normalizedData.emailTerceiros || null,
...
function fromRow(row: Record<string, unknown>): FichaRecord {
  ...
  return {
    ...
    telefoneTerceiros: String(row.telefone_terceiros ?? ""),
    emailTerceiros: String(row.email_terceiros ?? ""),
