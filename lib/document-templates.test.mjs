...
test("does not add a contract heading to a procuration template", () => {
  const content = "<h1>PROCURAÇÃO</h1><p>Conteúdo</p>"

  assert.equal(prepareDocumentTemplateContent("procuration", content), content)
})
