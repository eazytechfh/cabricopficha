...
test("document summaries omit deadlines and expose the requested process and fine fields", () => {
  ...
  assert.match(documentTemplatesSource, /Instância da Multa:/)
  assert.match(documentTemplatesSource, /Auto DETRAN:/)
  assert.match(documentTemplatesSource, /Auto RENAINF:/)
  assert.match(documentTemplatesSource, /Placa:/)
